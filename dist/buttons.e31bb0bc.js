...
var pressable = function pressable(context, event, conditionData) {
  ...
  var hasBeenHoveredOver = states.toString().indexOf("hovered") > -1;
...
exports.makeCommonButton = exports.common = void 0;
  ...
  return {
    config: {
      ...
      states: {
        ...
        hovered: _objectSpread({}, (0, _base.base)().config)
      }
    },
...
},{"xstate":"../../../node_modules/xstate/es/index.js","./base":"base.js"}],"index.js":[function(require,module,exports) {
"use strict";
...
var button = (0, _common.makeCommonButton)();
var machine = (0, _xstate.interpret)(button).onTransition(function (state) {
  return console.log(state.toStrings());
});
machine.start();
machine.send("PRESSED");
machine.send("HOVERED");
machine.send("PRESSED");
},{"xstate":"../../../node_modules/xstate/es/index.js","./common":"common.js"}],"../../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
//# sourceMappingURL=/buttons.e31bb0bc.js.map