...
exports.makeBaseButton = exports.base = void 0;

var _xstate = require("xstate");

var pressable = function pressable(context, event, conditionData) {
  var states = conditionData.state.toStrings();
  var hasBeenHoveredOver = states.toString().indexOf("over") > -1;
  return hasBeenHoveredOver;
};

var base = function base(initialState) {
  return {
    config: {
      id: "basic",
      initial: "released",
...
var makeBaseButton = function makeBaseButton(initialState) {
...
exports.makeButtonState = exports.makeCommonButton = exports.common = void 0;
...
var common = function common(initialState) {
  return {
    config: {
      id: "common",
      initial: 'off',
    ...
    options: _objectSpread({}, (0, _base.base)().options)
  };
};

exports.common = common;

var makeCommonButton = function makeCommonButton(initialState) {
  var state = common(initialState);
  return (0, _xstate.Machine)(state.config, state.options);
};

exports.makeCommonButton = makeCommonButton;

var makeButtonState = function makeButtonState(initialState) {
  return (0, _xstate.interpret)(makeCommonButton(initialState)).start();
};
