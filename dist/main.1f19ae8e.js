...
},{}],"../../../../../node_modules/validator/es/lib/util/merge.js":[function(require,module,exports) {
"use strict";
...
},{}],"../../../../../node_modules/validator/es/lib/isByteLength.js":[function(require,module,exports) {
"use strict";
...
},{"./util/assertString":"../../../../../node_modules/validator/es/lib/util/assertString.js"}],"../../../../../node_modules/validator/es/lib/isFQDN.js":[function(require,module,exports) {
"use strict";
...
},{"./util/assertString":"../../../../../node_modules/validator/es/lib/util/assertString.js","./util/merge":"../../../../../node_modules/validator/es/lib/util/merge.js"}],"../../../../../node_modules/validator/es/lib/isIP.js":[function(require,module,exports) {
"use strict";
...
},{"./util/assertString":"../../../../../node_modules/validator/es/lib/util/assertString.js"}],"../../../../../node_modules/validator/es/lib/isEmail.js":[function(require,module,exports) {
"use strict";
...
},{"./util/assertString":"../../../../../node_modules/validator/es/lib/util/assertString.js","./util/merge":"../../../../../node_modules/validator/es/lib/util/merge.js","./isByteLength":"../../../../../node_modules/validator/es/lib/isByteLength.js","./isFQDN":"../../../../../node_modules/validator/es/lib/isFQDN.js","./isIP":"../../../../../node_modules/validator/es/lib/isIP.js"}],"../../../../../node_modules/validator/es/lib/isURL.js":[function(require,module,exports) {
"use strict";
...
},{"./util/assertString":"../../../../../node_modules/validator/es/lib/util/assertString.js","./isFQDN":"../../../../../node_modules/validator/es/lib/isFQDN.js","./isIP":"../../../../../node_modules/validator/es/lib/isIP.js","./util/merge":"../../../../../node_modules/validator/es/lib/util/merge.js"}],"../../../../../node_modules/xstate/es/_virtual/_tslib.js":[function(require,module,exports) {
"use strict";
...
var validate = (0, _xstate.assign)({
  validations: function validations(context, event) {
    var valid = true;
    valid = context._validators.map(function (validator) {
      var result = validator.validate(event.content);
      return {
        id: validator.id,
        valid: result.valid,
  ...
  valid: function valid(context, event) {
    var valid = true;
    valid = context._validators.map(function (validator) {
...
var text = function text(initialState) {
  return {
    config: {
      id: "text",
      initial: "main",
      context: {
        validations: [],
        valid: true,
        _validators: _toConsumableArray(initialState.validators)
      },
      states: {
        main: {
          on: {
...
var makeText = function makeText(initialState) {
  var state = text(initialState);
  return (0, _xstate.Machine)(state.config, state.options);
};

exports.makeText = makeText;

var makeTextState = function makeTextState(initialState, callback) {
  var interpreter = (0, _xstate.interpret)(makeText(initialState));
...
exports.makeTextState = makeTextState;
},{"xstate":"../../../../../node_modules/xstate/es/index.js"}],"../../../../../node_modules/@popperjs/core/lib/enums.js":[function(require,module,exports) {
"use strict";
...
},{}],"text.vue":[function(require,module,exports) {
"use strict";
    ...
    valid: {
      handler: function handler(isValid) {
        if (!isValid) {
          ...
          this.tip = (0, _core.createPopper)(test, errors, {
...
exports.default = _default;
        var $c2b59a = exports.default || module.exports;
      
      if (typeof $c2b59a === 'function') {
        $c2b59a = $c2b59a.options;
      }
    
        /* template */
        Object.assign($c2b59a, (function () {
          var render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c("div", { staticClass: "field", class: _vm.style }, [
    _c("span", { ref: "sizer", staticClass: "wrapper" }, [
      _c("input", {
        directives: [
          {
            name: "model",
        ...
        attrs: { type: "text", id: "test", size: "1" },
    ...
    _c(
      "div",
      { staticClass: "errors", attrs: { id: "errors" } },
      _vm._l(_vm.validations, function(validation, key) {
        return _c("span", { key: key, staticClass: "error-message" }, [
          _c("i", [_vm._v("error_outline")]),
          _vm._v(" " + _vm._s(validation.message) + "\n        ")
        ])
      }),
      0
    )
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$c2b59a', $c2b59a);
          } else {
            api.reload('$c2b59a', $c2b59a);
          }
        }
...
},{"@popperjs/core":"../../../../../node_modules/@popperjs/core/lib/index.js","_css_loader":"../../../../../node_modules/parcel-bundler/src/builtins/css-loader.js","vue-hot-reload-api":"../../../../../node_modules/vue-hot-reload-api/dist/index.js","vue":"../../../../../node_modules/vue/dist/vue.runtime.esm.js"}],"main.vue":[function(require,module,exports) {
"use strict";
...
var _default = {
  ...
  beforeMount: function beforeMount() {
    ...
    var validEmail = function validEmail(content) {
      var valid = (0, _isEmail.default)(content);
      var response = {
        valid: valid
      };
    ...
    var validURL = function validURL(content) {
      var valid = (0, _isURL.default)(content);
      var response = {
        valid: valid
      };
    ...
    this.text = (0, _text.makeTextState)({
      validators: validators
    }, function (state) {
      _this.isValid = state.valid;
      _this.validations = state.validations;
    });
  }
};
exports.default = _default;
        var $9933bc = exports.default || module.exports;
      
      if (typeof $9933bc === 'function') {
        $9933bc = $9933bc.options;
      }
    
        /* template */
        Object.assign($9933bc, (function () {
          var render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c(
    "div",
    [
      _c("h2", [_vm._v("1. Within paragraph")]),
      _vm._v(" "),
      _c(
        "p",
        [
          ...
          _c("textfield", {
            ...
            on: {
              change: function($event) {
                return _vm.text.send("CHANGE", { content: $event.value })
              }
            }
          }),
          _vm._v(", and I live in the United Kingdom\n    ")
        ],
        1
      ),
      _vm._v(" "),
      _c("h2", [_vm._v("2. As a form")]),
      _vm._v(" "),
      _c("textfield", {
        attrs: {
          value: "me@gmail.com",
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$9933bc', $9933bc);
          } else {
            api.reload('$9933bc', $9933bc);
          }
        }
...
},{"validator/es/lib/isEmail":"../../../../../node_modules/validator/es/lib/isEmail.js","validator/es/lib/isURL":"../../../../../node_modules/validator/es/lib/isURL.js","../../text":"../../text.js","./text":"text.vue","_css_loader":"../../../../../node_modules/parcel-bundler/src/builtins/css-loader.js","vue-hot-reload-api":"../../../../../node_modules/vue-hot-reload-api/dist/index.js","vue":"../../../../../node_modules/vue/dist/vue.runtime.esm.js"}],"main.js":[function(require,module,exports) {
"use strict";
